...
namespace MVC_Kutun.vi_vn
{
    public partial class Order_payment : System.Web.UI.Page
    {
        ...
        private void setOrder()
        {
            ...
            UserControl ucmember=Page.LoadControl("/UIs/history-payment.ascx") as UserControl;
            UserControl ucpartner = Page.LoadControl("/UIs/HistPayment_Partner.ascx") as UserControl;
            if (_usertype == 0)

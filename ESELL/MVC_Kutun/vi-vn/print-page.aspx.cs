...
namespace MVC_Kutun.vi_vn
{
    public partial class print_page : System.Web.UI.Page
    {
        ...
        public string Getbanner(object Banner_type, object banner_field, object Banner_ID, object Banner_Image)
        {
            ...
            return banner == "1" ? "<a href='/trang-chu.html' class='icon_pc'>" + GetImage(Banner_type, banner_field, Banner_ID, Banner_Image) + "</a>" : "<a href='/trang-chu.html' class='icon_mobile'>" + GetImage(Banner_type, banner_field, Banner_ID, Banner_Image) + "</a>";
        }

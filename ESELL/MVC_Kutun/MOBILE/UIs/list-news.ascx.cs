...
{
    public partial class list_news : System.Web.UI.UserControl
    {
        #region Declare
        ...
        public string GetImageT(object News_Id, object News_Image1, object url, object seo_url)
        {

            try
            {
                return fun.GetImageT_News_HasLink(News_Id, News_Image1, "imgnews", url, seo_url, "");
            }
            catch (Exception ex)
            {

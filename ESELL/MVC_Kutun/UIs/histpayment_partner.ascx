<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HistPayment_Partner.ascx.cs"
    Inherits="MVC_Kutun.UIs.HistPayment_Partner" %>
...
<div class="box_Tab_main">
    <h1 class="title_page" style="float:left">
        Đơn hàng của tôi</h1>
    <div style="float:right">
        <input type="text" id="txtdatefrom" class="input-txt" runat="server" clientidmode="Static"
            placeholder='Từ ngày' readonly="readonly" />
        <input type="text" id="txtdateto" class="input-txt" runat="server" clientidmode="Static"
            placeholder='Đến ngày' readonly="readonly" />
        <asp:LinkButton ID="Lbsearch" runat="server" CssClass="btn_web" OnClick="Lbsearch_Click" style="height:34px">Kiểm tra</asp:LinkButton>
    </div>
</div>
<div class="inner_2col">
    <table cellspacing="0" cellpadding="4" style="color: #0066FF; width: 100%; border-collapse: collapse"
        class="tdGridTable">
        <tbody>
            ...
            <asp:Repeater ID="Rphistory" runat="server">
                <ItemTemplate>
                    <tr class="box_order" style="cursor: pointer">
                        <td>
                            <img src="../vi-vn/Images/icon_order.png" width="20px">
                        </td>
                        <td>
                            <%#Eval("ORDER_CODE") %>
                        </td>
                        ...
                        <td colspan="7">
                                ...
                                <ItemTemplate>
                                    <div id="cart_page_user">
                                        <div class="row_th_cart">
                                            <h3 style="width: 15%; font-size: 14px;" class="th_table_cart fl">
                                                Hình ảnh
                                            </h3>
                                            <h3 style="width: 38%; font-size: 14px;" class="th_table_cart fl">
                                                Tên sản phẩm
                                            </h3>
                                            <h3 style="width: 16%; font-size: 14px;" class="th_table_cart fl">
                                                Giá bán
                                            </h3>
                                            <h3 style="width: 10%; font-size: 14px;" class="th_table_cart fl">
                                                Số lượng
                                            </h3>
                                            <h3 style="width: 20%; font-size: 14px;" class="th_table_cart fl">
                                                Thành tiền
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item_cart fl">
                                        <a class="img_cart fl" target="_parent" href="<%# GetLink(Eval("NEWS_URL"),Eval("NEWS_SEO_URL")) %>">
                                            <img width="100" height="100" alt="" src="<%# GetImageT(Eval("NEWS_ID"),Eval("NEWS_IMAGE3")) %>"></a>
                                        <div class="cell name">
                                            <div>
                                        ...
                                        <div class="cell unit">
                                            <span id="soldprice_1757" class="new">
                                        ...
                                        <div id="dealtotal_1757" class="cell total">
                                            <%# GetMoney(Eval("ITEM_SUBTOTAL"))%></div>
                                    </div>
                                    <!--end Item Cart-->
                                </ItemTemplate>
                            </asp:Repeater>
                            <div class="foo-cart">
                                <div class="total-cart">
                                    <p>
                                        Tổng cộng:<span id="total-sum">
                                            <%#GetMoney(Eval("ORDER_TOTAL_ALL"))%></span></p>
                                    <p>
                                        Phí vận chuyển:<span id="total-sum">
                                            <%#getship(Eval("ORDER_SHIPPING_FEE"))%></span></p>
                                    <p class="all_total">
                                        Thành tiền:<span id="total-money">
                                            <%#GetMoney(Eval("ORDER_TOTAL_AMOUNT"))%></span></p>
                                </div>
                            </div>
                        </td>
                    </tr>

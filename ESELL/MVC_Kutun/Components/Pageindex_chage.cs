...
namespace MVC_Kutun.Components
{
    ...
    {
        public string result(int tongsotin, int sotin, string cat_seo_url, int idarea,string listid, int _page, int type)
        {
        ...
        public string resultListproduct(int tongsotin, int sotin, string cat_seo_url, int idarea, string listid,string price,int typeprice,string _paramth, int _page, int type)
        {
            string _re = string.Empty;
            int kiemtradu = tongsotin % sotin;
            int _sotrang;
                ...
                for (int i = s; i <= _sotrang; i++)
                {
                    ...
                    else
                    {
                        ...
                        else if (type == 1)
                        {
                            ...
                            if (i == _sotrang && _page >= 7)
                            {
                                _re += "<a href='/" + cat_seo_url + ".html?code=&page=" + (_page + 1) + "&sort=" + _sortvl + "&price=" + price + "&typepri=" + typeprice + "&paramTH=" + _paramth + "&idcat=" + idarea + "'> >> </a>";
                            }
                            else if (i == s && _page >= 7)
                            {
                                _re += "<a href='/" + cat_seo_url + ".html?code=&page=" + (_page - 1) + "&sort=" + _sortvl + "&price=" + price + "&typepri=" + typeprice + "&paramTH=" + _paramth + "&idcat=" + idarea + "'> << </a>";
                                ...
                                _re += "<a href='/" + cat_seo_url + ".html?code=&page=" + i + "&sort=" + _sortvl + "&price=" + price + "&typepri=" + typeprice + "&paramTH=" + _paramth + "&idcat=" + idarea + "'>" + i + "</a>";
                        }

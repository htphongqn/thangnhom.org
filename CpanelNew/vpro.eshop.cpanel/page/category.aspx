                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div id="trUploadImage2" runat="server">
                                <span class="btn btn-default btn-file"><span class="glyphicon glyphicon-file" aria-hidden="true">
                                </span>&nbsp;Chọn ảnh<input id="fileImage2" type="file" name="fileImage1" size="50"
                                    runat="server" /></span>
                            </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">
                            Tên</label>
                        <div class="col-sm-10">
                            <input type="text" id="txtTen" runat="server" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:RadioButtonList ID="rblCatType" runat="server">
                                ...
                                <asp:ListItem Text="Hãng sản xuất" Value="2"></asp:ListItem>
                        ...
                        <div class="form-group">
                            <label>
                                Vị trí</label>
                            <asp:RadioButtonList ID="rblPos" runat="server" RepeatColumns="1">
                                <asp:ListItem Text="Menu chính" Value="1" Selected="True"></asp:ListItem>
                                <asp:ListItem Text="Danh mục trái" Value="2"></asp:ListItem>
                                <asp:ListItem Text="Menu chính và danh mục trái" Value="3"></asp:ListItem>
                                <asp:ListItem Text="Khác" Value="10"></asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                        <div class="form-group">
                            ...
                            <asp:RadioButtonList ID="rblShowFooter" runat="server">
                                <asp:ListItem Selected="True" Text="Không" Value="0"></asp:ListItem>
                                <asp:ListItem Text="Trên" Value="1"></asp:ListItem>
                                <asp:ListItem Text="Danh mục nổi bật" Value="2"></asp:ListItem>
                            </asp:RadioButtonList>
                        </div>
                        <div class="form-group">
                            <label>

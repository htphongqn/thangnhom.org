...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="col-sm-3 col-md-offset-1 thumbnail">
                <a href="news_list.aspx?type=1">
                    <img class="img-rounded" src="../Images/Icon/ic-pro.png" /></a>
                <div class="caption text-center">
                    <h4>
                        Sản phẩm</h4>
                </div>
                ...
                <div class="panel-heading" role="tab" id="headingOne">
                    <h3 class="panel-title" id="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true"
                            aria-controls="collapseOne">Đơn hàng ngày hôm nay<span class="glyphicon glyphicon-download navbar-right"
                                aria-hidden="true" style="margin: 0"></span></a>
                    </h3>
                </div>
                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                    <div class="panel-body text-center">
                        <uc1:Ordernow ID="Ordernow1" runat="server" />
                    </div>
                </div>
            </div>
            <div class="panel panel-info">

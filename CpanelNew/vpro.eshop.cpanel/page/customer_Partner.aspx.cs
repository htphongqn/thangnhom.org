...
{
    public partial class customer_Partner : System.Web.UI.Page
    {
        #region Declare
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Hyperback.NavigateUrl = "customer_Partner_List.aspx";
            if (m_customer_id == 0)
            {
        ...
        protected void lbtSaveNew_Click(object sender, EventArgs e)
        {
            if (CheckExits(txtCustomerEmail.Value))
                ...
                SaveInfo("customer_Partner.aspx");
        }
        protected void LbsaveClose_Click(object sender, EventArgs e)
        {
            if (CheckExits(txtCustomerEmail.Value))
                ...
                SaveInfo("customer_Partner_List.aspx");
        }
        ...
        private void getInfo()
        {
            try
            {
                ...
                {
                    txtcuscode.Value = G_info.ToList()[0].CUSTOMER_CODEID;
                    ...
                    txtcodebank.Value = Utils.CStrDef(G_info.ToList()[0].CUSTOMER_CODEBANK);
        ...
        private void DeleteInfo()
        {
            try
            {
                ...
                Response.Redirect("customer_Partner_List.aspx");

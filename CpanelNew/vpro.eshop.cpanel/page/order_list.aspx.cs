...
namespace vpro.eshop.cpanel.page
{
    public partial class order_list : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                if (_gtype != 1)
                {
                    ...
                    var AllList = (from o in DB.ESHOP_ORDERs
                                   ...
                                   join c in DB.ESHOP_NEWs on o_i.NEWS_ID equals c.NEWS_ID 
        ...
        public string gettotalamount(object orderId)
        {
            string[] arrShop = _gshop.Split(',');
            int order = Utils.CIntDef(orderId);
            ...
            return GetMoney(AllList.Sum(a => a.ITEM_SUBTOTAL));

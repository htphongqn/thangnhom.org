        ...
        private void getInfo()
        {
            try
            {
                ...
                if (G_info.ToList().Count > 0)
                {
                    ...
                    txtTen.Value = Utils.CStrDef(G_info.ToList()[0].CAT_FIELD1);
                    txtLienket.Value = Utils.CStrDef(G_info.ToList()[0].CAT_FIELD2);
        ...
        private void SaveInfo(string strLink = "")
        {
            try
            {
                ...
                if (m_cat_id == 0)
                {
                    ...
                    cat_insert.CAT_FIELD1 = txtTen.Value;
                    cat_insert.CAT_FIELD2 = txtLienket.Value;
                ...
                else
                {
                    ...
                    if (c_update.ToList().Count > 0)
                    {
                        ...
                        c_update.Single().CAT_FIELD1 = txtTen.Value;
                        c_update.Single().CAT_FIELD2 = txtLienket.Value;

...
{
    public partial class customer_Partner_List : System.Web.UI.Page
    {
        #region Declare
        ...
        {
            return "customer_Partner.aspx?customer_id=" + Utils.CStrDef(obj_id);
        }
        ...
        {
            return Utils.CIntDef(active) == 1 ? "Rồi" : "Chưa";
        }

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="xuat-kho.aspx.cs" Inherits="vpro.eshop.cpanel.page.xuat_kho" %>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">
                            Chọn lần nhập kho</label>
                        <div class="col-sm-10">
                            <asp:DropDownList ID="Drnhapkho" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Drnhapkho_SelectedIndexChanged" class="form-control">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div class="form-group">

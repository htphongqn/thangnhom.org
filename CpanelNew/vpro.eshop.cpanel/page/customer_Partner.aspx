<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="customer_Partner.aspx.cs" Inherits="vpro.eshop.cpanel.page.customer_Partner" %>
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">
                            Mã đại lý</label>
                        <div class="col-sm-9">
                            <input type="text" name="txtcuscode" id="txtcuscode" runat="server" class="form-control"
                                readonly="readonly" />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="txtcodebank" id="txtcodebank" runat="server" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">

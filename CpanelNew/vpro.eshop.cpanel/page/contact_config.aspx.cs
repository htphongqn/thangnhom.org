...
namespace vpro.eshop.cpanel.page
{
    public partial class contact_config : System.Web.UI.Page
    {
        ...
        private void showFileHTML6()
        {
            ...
            pathFile = Server.MapPath(PathFiles.GetPathContact() + "/contact-seo.htm");
        ...
        private void SaveHTMLInfo5()
        {
            try
            {
                ...
                strFileName = PathFiles.GetPathContact() + "/contact-printorder.htm";
                strHTMLFileLocation = Server.MapPath(strFileName);
        ...
        private void SaveHTMLInfo6()
        {
            try
            {
                ...
                strFileName = PathFiles.GetPathContact() + "/contact-seo.htm";
                strHTMLFileLocation = Server.MapPath(strFileName);

    ...
    public class PageIndexChange
    {
        ...
        public string changePageNews(string url, int tongsotin, int sotin, int _page, int _type)
        {
            ...
            else
            {
                ...
                if(_sotrangfirstload>_page&&_sotrangfirstload>7)
                    _re += "<li><a href='" + url + "?page=" + _sotrangfirstload + "&type=" + _type + "'> ... " + _sotrangfirstload + "</a></li>";
            }
            return _re;
        }
    }

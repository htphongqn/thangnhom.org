                ...
                <div class="panel-body">
                    <table class="table table-striped">
                        <tr>
                            ...
                            <td>
                                <%--<input type="checkbox" id="Checkbox3" runat="server" onclick="javascript: ToggleAll(this,0);"
                                    name="toggleSign">--%>
                            </td>
                            <td>
                                Tên shop
                        ...
                        <asp:Repeater ID="rptShop" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <%# getOrder() %>
                                        <asp:HiddenField ID="HdShopid" runat="server" Value='<%#Eval("ID") %>' />
                                    </td>
                                    <td>
                                        <input id="chkShop" type="checkbox" name="chkSelect" runat="server" checked='<%#CheckShop(Eval("ID")) %>'>
                                    </td>
                                    <td>
                                        <%#Eval("NAME")%>
                                    </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="shop_list.aspx.cs" Inherits="vpro.eshop.cpanel.page.shop_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row page-header">
        <a href="shop.aspx" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"
                    ...
                    <asp:Repeater ID="Rplistcate" runat="server" OnItemCommand="Rplistcate_ItemCommand">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href='<%# getLink(Eval("ID")) %>'><span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                </td>
                                <td class="text-center">

<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="customer_Partner_List.aspx.cs" Inherits="vpro.eshop.cpanel.page.customer_Partner_List" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row page-header">
        <a href="customer_Partner.aspx" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-center">
                                    <%# getActive(Eval("CUSTOMER_SHOWTYPE"))%>
                                </td>
                                <td class="text-center">

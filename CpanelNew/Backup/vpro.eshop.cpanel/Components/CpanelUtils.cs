...
namespace vpro.eshop.cpanel.Components
{
    public static class CpanelUtils
    {
        ...
        public static List<string[]> listAds()
        {
            ...
            { 
                new string[] { "0", "Slider" }, 
                new string[] { "2", "Phải silder" },
                new string[] { "3", "Phải sản phẩm nổi bật" },
                new string[] { "4", "Thương hiệu chuyên mục" },
                new string[] { "5", "Quảng cáo chuyên mục" },
                new string[] { "6", "Phải hỗ trợ" },
                new string[] { "10", "Khác" },
            };
            return l;
        }
